<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->hasRole('customer'))
                    {{-- Customer Menu --}}
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('merchants.map')" :active="request()->routeIs('merchants.map')">
                            🗺️ Peta Merchant
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->hasRole('customer'))
                <x-responsive-nav-link :href="route('merchants.map')" :active="request()->routeIs('merchants.map')">
                    🗺️ Peta Merchant
                </x-responsive-nav-link>
            ...
            @if (Auth::user()->hasRole('admin'))
                <x-responsive-nav-link :href="route('merchants.index')" :active="request()->routeIs('merchants.*')">
                    🏪 Merchants
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('foodmenu.index')" :active="request()->routeIs('foodmenu.*')">
                    🍽️ All Menu
